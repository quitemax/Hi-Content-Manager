HiGridWidget = function(containerId, url, pageVar, sortVar, dirVar, limitVar, filterVar) {
  this.init(containerId, url, pageVar, sortVar, dirVar, limitVar, filterVar);
}

$.extend(HiGridWidget.prototype, {
    ...
    getFullGridUrl: function() {
        var url = this.url;
        
        url = url + '?' + this.limitVar + '=' + this.limitValue;
        url = url + '&' + this.pageVar + '=' + this.pageValue;
        url = url + '&' + this.sortVar + '=' + this.sortValue;
        url = url + '&' + this.dirVar + '=' + this.dirValue;
        url = url + '&' + this.filterVar + '=' + this.filterValue;
        
        return url;
    },
    setLimit: function(selectObject) {
        select = $(selectObject) ;
        //
    ...
    inputPage: function(element, event, lastPage) {
    ...
    sort: function(anchorObject) {
        //asdf
        anchor = $(anchorObject);

        //
        var sort = anchor.attr('name');
        var dir = anchor.attr('title');
    ...
    doFilter: function(element, event) {
