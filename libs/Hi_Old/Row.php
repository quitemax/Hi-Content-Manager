...
//require_once 'Hi/Record/SubForm.php';//autoload

/**
 * Hi_Record_SubForm_Row
 *
 * @category   Hi
 * @package    Hi_Record
 * @copyright  Copyright (c) 2009 Piotr Maxymilian Socha
 ...
 * @version    2.0
 */
class Hi_Record_SubForm_Row extends Hi_Record_SubForm
{
    /**#@+
     * Row id template
     */
     ...
     */
	const DEFAULT_PARTIALS_DIR = 'record/row/';
	/**#@-*/
     ...
     * @var string
     */
    protected $_partialsDir = Hi_Record_SubForm_Row::DEFAULT_PARTIALS_DIR;
     ...
     *  @var int
     */
    protected $_colspan = Hi_Record_SubForm_Row::DEFAULT_COLSPAN;
    ...
    public function build()
    {
        ...
        if (count($this->_actions)) {
        	//
        	$actionSubform = new Zend_Form_SubForm(
        	    array('disableLoadDefaultDecorators' => true)
        	);
