...
//    }
     ...
     * @return string
     */
    public function prepareRowsetSql($where = null, $order = null, $count = null, $offset  = null, $cols = null)
    {
...
//        echo $sqlSelect;
     ...
     * @return string
     */
    public function getRowset($where = null, $order = null, $count = null, $offset  = null, $cols = null)
    {
        //prepare the sql
        $sqlSelect = $this->prepareRowsetSql($where, $order, $count, $offset, $cols);
