...
use Zend\Mvc\Controller\ActionController,
    ...
    HiTraining\Form\CheckupProfile\Grid as ProfileGrid,
    HiTraining\Form\CheckupProfile\ResultSet as ProfileResultSet,
    HiTraining\Form\CheckupProfile\Row as ProfileRow,
    HiTraining\Form\CheckupToProfile\Grid as CheckupToProfileGrid,
    HiTraining\Form\CheckupToProfile\ResultSet as CheckupToProfileResultSet,
    HiTraining\Form\CheckupToProfile\Row as CheckupToProfileRow;
    ...
    public function listAction()
    {
        ...
        $this->_view->headScript()->appendScript(
            $this->_view->render(
                'checkup/list.js',
                array(
                    'delete' => $this->url()->fromRoute('hi-training/checkup-profile/delete/wildcard', array('profile_id' => '')),
                    'edit' => $this->url()->fromRoute('hi-training/checkup-profile/edit/wildcard', array('profile_id' => '')),
                    'add' => $this->url()->fromRoute('hi-training/checkup-profile/add'),
                )
            )
        );
...
//                'onclick'   => 'goBack(); return false;',
        ...
        $this->_view->headScript()->appendScript(
            $this->_view->render(
                ...
                array(
                    'back' => $this->url()->fromRoute('hi-training/checkup-profile/list'),
                )
            )
        );
                    ...
                    if (isset($formData['CheckupProfileRowSubForm']['actions']['save']) || isset($formData['CheckupProfileRowSubForm']['actions']['saveAndContinue'])) {
                        ...
                        if (is_array($formData['CheckupProfileRowSubForm']['row'])){
                            ...
                            if (isset($formData['CheckupProfileRowSubForm']['actions']['save'])) {
                                ...
                                return $this->redirect()->toRoute('hi-training/checkup-profile/edit/wildcard', array('profile_id' => $newRow->getId()));
                ...
                if (    isset($formData['header']['formId'])
                    ...
                    if (isset($formData['CheckupToProfileRowSubForm']['actions']['save'])) {
                        ...
                        if (is_array($formData['CheckupToProfileRowSubForm']['row'])){
                            ...
                            return $this->redirect()->toRoute('hi-training/checkup-profile/edit/wildcard', array('profile_id' => $id));
                        }
                    }
